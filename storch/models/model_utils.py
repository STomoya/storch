...
def get_dtype_from_module(module: nn.Module):
    module_vars = get_parameters_and_buffers(module)
    try:
        first_var = next(module_vars)
    except StopIteration:
