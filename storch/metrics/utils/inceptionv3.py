...
class InceptionV3JIT(nn.Module):
    ...
    def __init__(self,
        feature_dims=2048,
        weight_folder='./.cache/storch/metrics', filename='jit-inception-2015-12-05.torch'
    ) -> None:
        super().__init__()
...
class InceptionV3(nn.Module):
    ...
    def __init__(self,
        feature_dims = 2048,
        weight_folder='./.cache/storch/metrics', filename='inception-2015-12-05.torch'
    ) -> None:
        super().__init__()
...
class InceptionA(inception.InceptionA):
...
class InceptionC(inception.InceptionC):
    def _forward(self, x):
        branch1x1 = self.branch1x1(x)
...
class InceptionE_1(inception.InceptionE):
    def _forward(self, x):
        branch1x1 = self.branch1x1(x)
...
class InceptionE_2(inception.InceptionE):
    def _forward(self, x):
        branch1x1 = self.branch1x1(x)
