...
class DataLoaderWrapper(DataLoader):
    ...
    def from_dataloader(cls,
        ...
        kwargs.shuffle        = isinstance(dataloader.batch_sampler.sampler, RandomSampler)
        kwargs.drop_last      = dataloader.drop_last
        kwargs.num_workers    = dataloader.num_workers
        kwargs.pin_memory     = dataloader.pin_memory
        kwargs.worker_init_fn = dataloader.worker_init_fn
        kwargs.generator      = dataloader.generator
