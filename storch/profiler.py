...
def get_tb_profile(
    ...
    profile_schedule: schedule | None = None,
    ...
    ----
        ...
        profile_schedule (schedule, optional): Profiling schedule. Use when tracing long process.
    ...
    if profile_schedule is None:
        profile_schedule = schedule(wait=1, warmup=1, active=3, repeat=2)
    profile_obj = profile(
